...
uint256 hashGenesisBlock("0x00000000ff9b154efe65f5b64cc552b36d1873280ae7873ddcc3454eb4df6691");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 190000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 190000);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000ff9b154efe65f5b64cc552b36d1873280ae7873ddcc3454eb4df6691");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1423419320;
        block.nBits    = 486604799;
        block.nNonce   = 2233386967;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ePAYERCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ePAYERCOINMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ePAYERCOINMiner started\n");
    ...
    try { loop {
        ...
        printf("Running ePAYERCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ePAYERCOINMiner terminated\n");
        throw;
    }
}
